...
@section ("title", "新着情報修正確認")

@section ("content")
<div class="container">
  <h1>新着情報修正確認</h1>
  <p class="caution">以下の通り新着情報を修正します</p>
  <form action="/news/edit/complete" method="post" name="complete">
    @csrf
...
<form action="/news/edit/{{$id}}" method="post" name="back">
  @csrf
